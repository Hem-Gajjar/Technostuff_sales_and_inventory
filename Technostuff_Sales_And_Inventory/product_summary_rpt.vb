...
Public Class product_summary_rpt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "product_summary_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Technostuff_Sales_And_Inventory.product_summary_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedproduct_summary_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As product_summary_rpt = New product_summary_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
