...
Public Class sales_summary_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Technostuff_Sales_And_Inventory.sales_summary_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsales_summary_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As sales_summary_rpt = New sales_summary_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
